...
public class Pinsir extends Pokemon {
    ...
    private static int MIN_CP = 1787;
    private static int MAX_CP = 2122;
    ...
    private static ChargeAttack CHARGE_ATTACK_1 = new Submission();
    private static ChargeAttack CHARGE_ATTACK_2 = new ViceGrip();
    private static ChargeAttack CHARGE_ATTACK_3 = new XScissor();

    public Pinsir(Context context, int id) {
        super(context, id);
    ...
    public Pinsir(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.pinsir);
        super.mResource = R.drawable.p127;
    }
