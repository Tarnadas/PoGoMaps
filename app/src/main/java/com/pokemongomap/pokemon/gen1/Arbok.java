...
public class Arbok extends Pokemon {
    ...
    public Arbok(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.arbok);
        super.mResource = R.drawable.p24;
    }
