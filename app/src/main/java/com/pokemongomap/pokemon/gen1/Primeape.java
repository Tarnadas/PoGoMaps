...
public class Primeape extends Pokemon {
    ...
    private static int ATTACK_RATIO = 178;
    private static int DEFENSE_RATIO = 150;
    private static int MIN_CP = 1552;
    private static int MAX_CP = 1865;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new KarateChop();
    private static BasicAttack BASE_ATTACK_2 = new LowKick();
    private static List<ChargeAttack> CHARGE_ATTACKS = new ArrayList<>();
    private static ChargeAttack CHARGE_ATTACK_1 = new CrossChop();
    private static ChargeAttack CHARGE_ATTACK_2 = new LowSweep();
    private static ChargeAttack CHARGE_ATTACK_3 = new NightSlash();

    public Primeape(Context context, int id) {
        super(context, id);
        ...
        super.MIN_CP = MIN_CP;
        super.MAX_CP = MAX_CP;
        super.TYPE = TypeModifier.Type.FIGHTING;
    ...
    public Primeape(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.primeape);
        super.mResource = R.drawable.p57;
    }
