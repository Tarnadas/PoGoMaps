...
public class Rhyhorn extends Pokemon {
    ...
    private static int DEFENSE_RATIO = 116;
    private static int MIN_CP = 936;
    private static int MAX_CP = 1182;
    ...
    public Rhyhorn(Context context, int id) {
        super(context, id);
    ...
    public Rhyhorn(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.rhyhorn);
        super.mResource = R.drawable.p111;
    }
