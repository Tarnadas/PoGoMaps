...
public class Mankey extends Pokemon {
    ...
    private static int ATTACK_RATIO = 122;
    private static int DEFENSE_RATIO = 96;
    private static int MIN_CP = 668;
    private static int MAX_CP = 879;
    ...
    public Mankey(Context context, int id) {
        super(context, id);
    ...
    public Mankey(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.mankey);
        super.mResource = R.drawable.p56;
    }
