...
public class Machamp extends Pokemon {
    ...
    private static int MIN_CP = 2226;
    private static int MAX_CP = 2594;
    ...
    private static ChargeAttack CHARGE_ATTACK_2 = new StoneEdge();
    private static ChargeAttack CHARGE_ATTACK_3 = new Submission();

    public Machamp(Context context, int id) {
        super(context, id);
    ...
    public Machamp(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.machamp);
        super.mResource = R.drawable.p68;
    }
