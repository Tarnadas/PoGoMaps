...
public class Goldeen extends Pokemon {
    ...
    public Goldeen(Context context, int id) {
        super(context, id);
    ...
    public Goldeen(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.goldeen);
        super.mResource = R.drawable.p118;
    }
