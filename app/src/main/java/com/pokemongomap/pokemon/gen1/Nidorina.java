...
public class Nidorina extends Pokemon {
    ...
    private static int MIN_CP = 1138;
    private static int MAX_CP = 1405;
    ...
    public Nidorina(Context context, int id) {
        super(context, id);
    ...
    public Nidorina(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.nidorina);
        super.mResource = R.drawable.p30;
    }
