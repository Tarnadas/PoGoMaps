...
public class Scyther extends Pokemon {
    ...
    private static int MIN_CP = 1745;
    private static int MAX_CP = 2074;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new FuryCutter();
    private static BasicAttack BASE_ATTACK_2 = new SteelWing();
    private static List<ChargeAttack> CHARGE_ATTACKS = new ArrayList<>();
    private static ChargeAttack CHARGE_ATTACK_1 = new BugBuzz();
    private static ChargeAttack CHARGE_ATTACK_2 = new NightSlash();
    private static ChargeAttack CHARGE_ATTACK_3 = new XScissor();

    public Scyther(Context context, int id) {
        super(context, id);
        super.mResource = R.drawable.p123;
    ...
    public Scyther(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.scyther);
        super.mResource = R.drawable.p123;
    }

    @Override
    public boolean equals(Object obj) {
        return super.equals(obj) && obj instanceof Scyther;
    }
}
