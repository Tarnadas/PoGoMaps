...
public class Koffing extends Pokemon {
    ...
    private static int MAX_CP = 1152;
    ...
    public Koffing(Context context, int id) {
        super(context, id);
    ...
    public Koffing(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.koffing);
        super.mResource = R.drawable.p109;
    }
