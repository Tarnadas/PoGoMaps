...
public class Vileplume extends Pokemon {
    ...
    private static int ATTACK_RATIO = 202;
    private static int DEFENSE_RATIO = 190;
    private static int MIN_CP = 2130;
    private static int MAX_CP = 2493;
    ...
    private static ChargeAttack CHARGE_ATTACK_2 = new PetalBlizzard();
    private static ChargeAttack CHARGE_ATTACK_3 = new SolarBeam();

    public Vileplume(Context context, int id) {
        super(context, id);
    ...
    public Vileplume(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.vileplume);
        super.mResource = R.drawable.p45;
    }
