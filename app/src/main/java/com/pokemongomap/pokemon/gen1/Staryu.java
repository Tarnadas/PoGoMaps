...
public class Staryu extends Pokemon {
    ...
    private static int ATTACK_RATIO = 130;
    private static int DEFENSE_RATIO = 128;
    private static int MIN_CP = 712;
    private static int MAX_CP = 938;
    ...
    public Staryu(Context context, int id) {
        super(context, id);
    ...
    public Staryu(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.staryu);
        super.mResource = R.drawable.p120;
    }
