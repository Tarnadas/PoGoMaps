...
public class Exeggutor extends Pokemon {
    ...
    private static int MIN_CP = 2558;
    private static int MAX_CP = 2955;
    ...
    public Exeggutor(Context context, int id) {
        super(context, id);
    ...
    public Exeggutor(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.exeggutor);
        super.mResource = R.drawable.p103;
    }
