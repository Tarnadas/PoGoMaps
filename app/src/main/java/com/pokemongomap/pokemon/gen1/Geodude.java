...
public class Geodude extends Pokemon {
    ...
    private static int MIN_CP = 643;
    private static int MAX_CP = 849;
    ...
    public Geodude(Context context, int id) {
        super(context, id);
        super.mResource = R.drawable.p74;
    ...
    public Geodude(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.geodude);
        super.mResource = R.drawable.p74;
    }

    @Override
    public boolean equals(Object obj) {
        return super.equals(obj) && obj instanceof Geodude;
    }
}
