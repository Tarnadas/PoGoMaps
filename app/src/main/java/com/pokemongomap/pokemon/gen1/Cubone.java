...
public class Cubone extends Pokemon {
    ...
    private static int ATTACK_RATIO = 102;
    private static int DEFENSE_RATIO = 150;
    private static int MIN_CP = 780;
    private static int MAX_CP = 1007;
    ...
    private static ChargeAttack CHARGE_ATTACK_1 = new BoneClub();
    private static ChargeAttack CHARGE_ATTACK_2 = new Bulldoze();
    private static ChargeAttack CHARGE_ATTACK_3 = new Dig();

    public Cubone(Context context, int id) {
        super(context, id);
    ...
    public Cubone(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.cubone);
        super.mResource = R.drawable.p104;
    }
