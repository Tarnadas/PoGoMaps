...
public class Jynx extends Pokemon {
    ...
    private static int DEFENSE_RATIO = 134;
    private static int MIN_CP = 1418;
    private static int MAX_CP = 1717;
    ...
    private static ChargeAttack CHARGE_ATTACK_1 = new DrainingKiss();
    private static ChargeAttack CHARGE_ATTACK_2 = new IcePunch();
    private static ChargeAttack CHARGE_ATTACK_3 = new Psyshock();

    public Jynx(Context context, int id) {
        super(context, id);
        ...
        super.MIN_CP = MIN_CP;
        super.MAX_CP = MAX_CP;
        super.TYPE = TypeModifier.Type.ICE;
    ...
    public Jynx(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.jynx);
        super.mResource = R.drawable.p124;
    }
