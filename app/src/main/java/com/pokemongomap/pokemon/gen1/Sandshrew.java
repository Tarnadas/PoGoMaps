...
public class Sandshrew extends Pokemon {
    ...
    private static int DEFENSE_RATIO = 114;
    private static int MIN_CP = 600;
    private static int MAX_CP = 799;
    ...
    public Sandshrew(Context context, int id) {
        super(context, id);
    ...
    public Sandshrew(Context context, int id, LatLng loc, Date disappearTime) {
