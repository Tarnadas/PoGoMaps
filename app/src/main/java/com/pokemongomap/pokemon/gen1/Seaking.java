...
public class Seaking extends Pokemon {
    ...
    private static int MIN_CP = 1719;
    private static int MAX_CP = 2044;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new Peck();
    private static BasicAttack BASE_ATTACK_2 = new PoisonJab();
    private static List<ChargeAttack> CHARGE_ATTACKS = new ArrayList<>();
    private static ChargeAttack CHARGE_ATTACK_1 = new IcyWind();
    private static ChargeAttack CHARGE_ATTACK_2 = new MegaHorn();
    private static ChargeAttack CHARGE_ATTACK_3 = new DrillRun();

    public Seaking(Context context, int id) {
        super(context, id);
    ...
    public Seaking(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.seaking);
        super.mResource = R.drawable.p119;
    }
