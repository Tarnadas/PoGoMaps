...
public class Tauros extends Pokemon {
    ...
    private static int DEFENSE_RATIO = 184;
    private static int MIN_CP = 1536;
    private static int MAX_CP = 1845;
    ...
    public Tauros(Context context, int id) {
        super(context, id);
    ...
    public Tauros(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.tauros);
        super.mResource = R.drawable.p128;
    }
