...
public class Krabby extends Pokemon {
    ...
    private static int MIN_CP = 589;
    private static int MAX_CP = 792;
    ...
    public Krabby(Context context, int id) {
        super(context, id);
    ...
    public Krabby(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.krabby);
        super.mResource = R.drawable.p98;
    }
