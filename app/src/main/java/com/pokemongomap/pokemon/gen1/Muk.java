...
public class Muk extends Pokemon {
    ...
    private static int DEFENSE_RATIO = 188;
    private static int MIN_CP = 2234;
    private static int MAX_CP = 2603;
    ...
    public Muk(Context context, int id) {
        super(context, id);
    ...
    public Muk(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.muk);
        super.mResource = R.drawable.p89;
    }
