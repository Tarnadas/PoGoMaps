...
public class Hypno extends Pokemon {
    ...
    private static int HP_RATIO = 170;
    private static int ATTACK_RATIO = 162;
    private static int DEFENSE_RATIO = 196;
    private static int MIN_CP = 1847;
    private static int MAX_CP = 2184;
    ...
    private static ChargeAttack CHARGE_ATTACK_1 = new Psychic();
    private static ChargeAttack CHARGE_ATTACK_2 = new Psyshock();
    private static ChargeAttack CHARGE_ATTACK_3 = new ShadowBall();

    public Hypno(Context context, int id) {
        super(context, id);
    ...
    public Hypno(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.hypno);
        super.mResource = R.drawable.p97;
    }
