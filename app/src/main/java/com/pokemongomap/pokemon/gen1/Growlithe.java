...
public class Growlithe extends Pokemon {
    ...
    public Growlithe(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.growlithe);
        super.mResource = R.drawable.p58;
    }

    @Override
    public boolean equals(Object obj) {
        return super.equals(obj) && obj instanceof Growlithe;
    }
}
