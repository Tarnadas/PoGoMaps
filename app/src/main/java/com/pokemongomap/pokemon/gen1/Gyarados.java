...
public class Gyarados extends Pokemon {
    ...
    private static int MIN_CP = 2314;
    private static int MAX_CP = 2689;
    ...
    public Gyarados(Context context, int id) {
        super(context, id);
    ...
    public Gyarados(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.gyarados);
        super.mResource = R.drawable.p130;
    }
