...
public class Gastly extends Pokemon {
    ...
    private static int ATTACK_RATIO = 136;
    private static int DEFENSE_RATIO = 82;
    private static int MIN_CP = 596;
    private static int MAX_CP = 804;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new Lick();
    private static BasicAttack BASE_ATTACK_2 = new SuckerPunch();
    ...
    private static ChargeAttack CHARGE_ATTACK_3 = new OminousWind();

    public Gastly(Context context, int id) {
        super(context, id);
        super.mResource = R.drawable.p92;
    ...
    public Gastly(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.gastly);
        super.mResource = R.drawable.p92;
    }

    @Override
    public boolean equals(Object obj) {
        return super.equals(obj) && obj instanceof Gastly;
    }
}
