...
public class Dragonair extends Pokemon {
    ...
    public Dragonair(Context context, int id) {
        super(context, id);
    ...
    public Dragonair(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.dragonair);
        super.mResource = R.drawable.p148;
    }
