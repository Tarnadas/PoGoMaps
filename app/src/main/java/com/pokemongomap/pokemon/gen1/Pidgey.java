...
public class Pidgey extends Pokemon {
    ...
    private static int ATTACK_RATIO = 94;
    ...
    public Pidgey(Context context, int id) {
        super(context, id);
    ...
    public Pidgey(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.pidgey);
        super.mResource = R.drawable.p16;
    }
