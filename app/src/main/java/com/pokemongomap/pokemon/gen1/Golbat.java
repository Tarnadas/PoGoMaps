...
public class Golbat extends Pokemon {
    ...
    private static int ATTACK_RATIO = 164;
    private static int DEFENSE_RATIO = 164;
    private static int MIN_CP = 1607;
    private static int MAX_CP = 1921;
    ...
    public Golbat(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.golbat);
        super.mResource = R.drawable.p42;
    }
