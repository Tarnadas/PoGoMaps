...
public class Blastoise extends Pokemon {
    ...
    private static int HP_RATIO = 158;
    private static int ATTACK_RATIO = 186;
    private static int DEFENSE_RATIO = 222;
    private static int MIN_CP = 2176;
    private static int MAX_CP = 2542;
    ...
    public Blastoise(Context context, int id, LatLng loc, Date disappearTime) {
