...
public class Dewgong extends Pokemon {
    ...
    private static int DEFENSE_RATIO = 192;
    private static int MIN_CP = 1811;
    private static int MAX_CP = 2146;
    ...
    private static ChargeAttack CHARGE_ATTACK_2 = new Blizzard();
    private static ChargeAttack CHARGE_ATTACK_3 = new IcyWind();

    public Dewgong(Context context, int id) {
        super(context, id);
    ...
    public Dewgong(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.dewgong);
        super.mResource = R.drawable.p87;
    }
