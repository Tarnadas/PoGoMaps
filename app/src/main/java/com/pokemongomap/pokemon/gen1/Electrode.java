...
public class Electrode extends Pokemon {
    ...
    private static int MIN_CP = 1354;
    private static int MAX_CP = 1646;
    ...
    public Electrode(Context context, int id) {
        super(context, id);
    ...
    public Electrode(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.electrode);
        super.mResource = R.drawable.p101;
    }
