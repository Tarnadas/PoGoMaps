...
public class Dratini extends Pokemon {
    ...
    private static int HP_RATIO = 82;
    private static int ATTACK_RATIO = 128;
    private static int DEFENSE_RATIO = 110;
    private static int MIN_CP = 759;
    private static int MAX_CP = 983;
    ...
    public Dratini(Context context, int id) {
        super(context, id);
    ...
    public Dratini(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.dratini);
        super.mResource = R.drawable.p147;
    }
