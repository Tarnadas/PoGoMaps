...
public class Vaporeon extends Pokemon {
    ...
    private static int MIN_CP = 2428;
    private static int MAX_CP = 2816;
    ...
    public Vaporeon(Context context, int id) {
        super(context, id);
    ...
    public Vaporeon(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.vaporeon);
        super.mResource = R.drawable.p134;
    }
