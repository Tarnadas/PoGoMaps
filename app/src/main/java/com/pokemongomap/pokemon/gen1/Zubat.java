...
public class Zubat extends Pokemon {
    ...
    private static int ATTACK_RATIO = 88;
    private static int DEFENSE_RATIO = 90;
    private static int MIN_CP = 466;
    private static int MAX_CP = 643;
    ...
    public Zubat(Context context, int id) {
        super(context, id);
    ...
    public Zubat(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.zubat);
        super.mResource = R.drawable.p41;
    }
