...
public class Onix extends Pokemon {
    ...
    private static int ATTACK_RATIO = 90;
    private static int DEFENSE_RATIO = 186;
    private static int MIN_CP = 641;
    private static int MAX_CP = 857;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new Tackle();
    private static BasicAttack BASE_ATTACK_2 = new RockThrow();
    private static List<ChargeAttack> CHARGE_ATTACKS = new ArrayList<>();
    private static ChargeAttack CHARGE_ATTACK_1 = new IronHead();
    private static ChargeAttack CHARGE_ATTACK_2 = new RockSlide();
    private static ChargeAttack CHARGE_ATTACK_3 = new StoneEdge();

    public Onix(Context context, int id) {
        super(context, id);
    ...
    public Onix(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.onix);
        super.mResource = R.drawable.p95;
    }
