...
public class Nidoranm extends Pokemon {
    ...
    private static int HP_RATIO = 92;
    private static int ATTACK_RATIO = 110;
    private static int DEFENSE_RATIO = 94;
    private static int MIN_CP = 639;
    private static int MAX_CP = 843;
    ...
    public Nidoranm(Context context, int id) {
        super(context, id);
    ...
    public Nidoranm(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.nidoranm);
        super.mResource = R.drawable.p32;
    }
