...
public class Kadabra extends Pokemon {
    ...
    private static int MIN_CP = 887;
    private static int MAX_CP = 1132;
    ...
    public Kadabra(Context context, int id) {
        super(context, id);
    ...
    public Kadabra(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.kadabra);
        super.mResource = R.drawable.p64;
    }
