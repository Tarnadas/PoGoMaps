...
public class Dodrio extends Pokemon {
    ...
    private static int MIN_CP = 1525;
    private static int MAX_CP = 1836;
    ...
    private static ChargeAttack CHARGE_ATTACK_3 = new DrillPeck();

    public Dodrio(Context context, int id) {
        super(context, id);
        super.mResource = R.drawable.p85;
    ...
    public Dodrio(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.dodrio);
        super.mResource = R.drawable.p85;
    }

    @Override
    public boolean equals(Object obj) {
        return super.equals(obj) && obj instanceof Dodrio;
    }
}
