...
public class Golduck extends Pokemon {
    ...
    private static int DEFENSE_RATIO = 176;
    private static int MIN_CP = 2033;
    private static int MAX_CP = 2387;
    ...
    public Golduck(Context context, int id) {
        super(context, id);
    ...
    public Golduck(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.golduck);
        super.mResource = R.drawable.p55;
    }
