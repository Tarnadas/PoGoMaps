...
public class Kingler extends Pokemon {
    ...
    private static int DEFENSE_RATIO = 168;
    private static int MIN_CP = 1511;
    private static int MAX_CP = 1823;
    ...
    public Kingler(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.kingler);
        super.mResource = R.drawable.p99;
    }
