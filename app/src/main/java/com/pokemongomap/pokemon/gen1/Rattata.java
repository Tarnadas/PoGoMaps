...
public class Rattata extends Pokemon {
    ...
    public Rattata(Context context, int id) {
        super(context, id);
    ...
    public Rattata(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.rattata);
        super.mResource = R.drawable.p19;
    }
