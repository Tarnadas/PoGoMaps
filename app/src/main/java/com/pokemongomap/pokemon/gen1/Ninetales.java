...
public class Ninetales extends Pokemon {
    ...
    private static ChargeAttack CHARGE_ATTACK_3 = new HeatWave();

    public Ninetales(Context context, int id) {
        super(context, id);
    ...
    public Ninetales(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.ninetales);
        super.mResource = R.drawable.p38;
    }
