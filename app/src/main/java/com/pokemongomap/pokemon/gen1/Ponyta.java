...
public class Ponyta extends Pokemon {
    ...
    private static int MIN_CP = 1233;
    private static int MAX_CP = 1516;
    ...
    public Ponyta(Context context, int id) {
        super(context, id);
    ...
    public Ponyta(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.ponyta);
        super.mResource = R.drawable.p77;
    }
