...
public class Tangela extends Pokemon {
    ...
    private static int MIN_CP = 1440;
    private static int MAX_CP = 1740;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new VineWhip();
    ...
    public Tangela(Context context, int id) {
        super(context, id);
    ...
    public Tangela(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.tangela);
        super.mResource = R.drawable.p114;
    }
