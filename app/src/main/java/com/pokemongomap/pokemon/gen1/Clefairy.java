...
public class Clefairy extends Pokemon {
    ...
    private static int ATTACK_RATIO = 116;
    private static int DEFENSE_RATIO = 124;
    private static int MIN_CP = 955;
    private static int MAX_CP = 1201;
    ...
    private static ChargeAttack CHARGE_ATTACK_3 = new Moonblast();

    public Clefairy(Context context, int id) {
        super(context, id);
    ...
    public Clefairy(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.clefairy);
        super.mResource = R.drawable.p35;
    }
