...
public class Cloyster extends Pokemon {
    ...
    private static int ATTACK_RATIO = 196;
    private static int DEFENSE_RATIO = 196;
    private static int MIN_CP = 1714;
    private static int MAX_CP = 2053;
    ...
    private static ChargeAttack CHARGE_ATTACK_3 = new IcyWind();

    public Cloyster(Context context, int id) {
        super(context, id);
    ...
    public Cloyster(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.cloyster);
        super.mResource = R.drawable.p91;
    }
