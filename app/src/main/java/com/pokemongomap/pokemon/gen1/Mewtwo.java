...
public class Mewtwo extends Pokemon {
    ...
    private static int HP_RATIO = 212;
    private static int ATTACK_RATIO = 284;
    private static int DEFENSE_RATIO = 202;
    private static int MIN_CP = 3671;
    private static int MAX_CP = 4145;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new Confusion();
    private static BasicAttack BASE_ATTACK_2 = new PsychoCut();
    private static List<ChargeAttack> CHARGE_ATTACKS = new ArrayList<>();
    private static ChargeAttack CHARGE_ATTACK_1 = new HyperBeam();
    private static ChargeAttack CHARGE_ATTACK_2 = new Psychic();
    private static ChargeAttack CHARGE_ATTACK_3 = new ShadowBall();

    public Mewtwo(Context context, int id) {
        super(context, id);
        super.mResource = R.drawable.p150;
    ...
    public Mewtwo(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.mewtwo);
        super.mResource = R.drawable.p150;
    }

    @Override
    public boolean equals(Object obj) {
        return super.equals(obj) && obj instanceof Mewtwo;
    }
}
