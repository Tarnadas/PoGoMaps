...
public class Ivysaur extends Pokemon {
    ...
    public Ivysaur(Context context, int id) {
        super(context, id);
    ...
    public Ivysaur(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.ivysaur);
        super.mResource = R.drawable.p2;
    }
