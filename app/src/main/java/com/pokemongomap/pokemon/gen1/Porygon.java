...
public class Porygon extends Pokemon {
    ...
    private static int MIN_CP = 1396;
    private static int MAX_CP = 1692;
    ...
    public Porygon(Context context, int id) {
        super(context, id);
    ...
    public Porygon(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.porygon);
        super.mResource = R.drawable.p137;
    }
