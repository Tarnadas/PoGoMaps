...
public class Nidorino extends Pokemon {
    ...
    private static int HP_RATIO = 122;
    private static int ATTACK_RATIO = 142;
    private static int DEFENSE_RATIO = 128;
    private static int MIN_CP = 1108;
    private static int MAX_CP = 1372;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new PoisonSting();
    ...
    private static ChargeAttack CHARGE_ATTACK_2 = new HornAttack();
    private static ChargeAttack CHARGE_ATTACK_3 = new SludgeBomb();

    public Nidorino(Context context, int id) {
        super(context, id);
        super.mResource = R.drawable.p33;
    ...
    public Nidorino(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.nidorino);
        super.mResource = R.drawable.p33;
    }

    @Override
    public boolean equals(Object obj) {
        return super.equals(obj) && obj instanceof Nidorino;
    }
}
