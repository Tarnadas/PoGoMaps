...
public class Moltres extends Pokemon {
    ...
    private static int ATTACK_RATIO = 242;
    private static int DEFENSE_RATIO = 194;
    private static int MIN_CP = 2824;
    private static int MAX_CP = 3240;
    ...
    public Moltres(Context context, int id) {
        super(context, id);
    ...
    public Moltres(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.moltres);
        super.mResource = R.drawable.p146;
    }
