...
public class Poliwag extends Pokemon {
    ...
    private static int ATTACK_RATIO = 108;
    private static int DEFENSE_RATIO = 98;
    private static int MIN_CP = 597;
    private static int MAX_CP = 796;
    ...
    private static ChargeAttack CHARGE_ATTACK_2 = new BubbleBeam();
    private static ChargeAttack CHARGE_ATTACK_3 = new MudBomb();

    public Poliwag(Context context, int id) {
        super(context, id);
        super.mResource = R.drawable.p60;
    ...
    public Poliwag(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.poliwag);
        super.mResource = R.drawable.p60;
    }

    @Override
    public boolean equals(Object obj) {
        return super.equals(obj) && obj instanceof Poliwag;
    }
}
