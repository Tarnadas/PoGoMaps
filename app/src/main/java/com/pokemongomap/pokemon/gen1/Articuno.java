...
public class Articuno extends Pokemon {
    ...
    private static int DEFENSE_RATIO = 242;
    private static int MIN_CP = 2581;
    private static int MAX_CP = 2978;
    ...
    private static ChargeAttack CHARGE_ATTACK_2 = new IceBeam();
    private static ChargeAttack CHARGE_ATTACK_3 = new IcyWind();

    public Articuno(Context context, int id) {
        super(context, id);
    ...
    public Articuno(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.articuno);
        super.mResource = R.drawable.p144;
    }
