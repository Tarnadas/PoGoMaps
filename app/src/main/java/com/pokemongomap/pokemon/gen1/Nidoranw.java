...
public class Nidoranw extends Pokemon {
    ...
    private static int ATTACK_RATIO = 100;
    private static int DEFENSE_RATIO = 104;
    private static int MIN_CP = 668;
    private static int MAX_CP = 876;
    ...
    public Nidoranw(Context context, int id) {
        super(context, id);
    ...
    public Nidoranw(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.nidoranw);
        super.mResource = R.drawable.p29;
    }
