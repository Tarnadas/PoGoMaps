...
public class Slowpoke extends Pokemon {
    ...
    private static int MIN_CP = 967;
    private static int MAX_CP = 1219;
    ...
    public Slowpoke(Context context, int id) {
        super(context, id);
    ...
    public Slowpoke(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.slowpoke);
        super.mResource = R.drawable.p79;
    }
