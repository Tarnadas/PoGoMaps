...
public class MrMime extends Pokemon {
    ...
    private static int MIN_CP = 1204;
    private static int MAX_CP = 1494;
    ...
    public MrMime(Context context, int id) {
        ...
        super.TYPE_SECONDARY = TypeModifier.Type.FAIRY;
    ...
    public MrMime(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.mrmime);
        super.mResource = R.drawable.p122;
    }
