...
public class Machoke extends Pokemon {
    ...
    private static int ATTACK_RATIO = 154;
    private static int DEFENSE_RATIO = 144;
    private static int MIN_CP = 1460;
    private static int MAX_CP = 1761;
    ...
    private static ChargeAttack CHARGE_ATTACK_3 = new Submission();

    public Machoke(Context context, int id) {
        super(context, id);
    ...
    public Machoke(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.machoke);
        super.mResource = R.drawable.p67;
    }
