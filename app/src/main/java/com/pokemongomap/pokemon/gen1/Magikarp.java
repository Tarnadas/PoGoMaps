...
public class Magikarp extends Pokemon {
    ...
    private static int HP_RATIO = 40;
    private static int ATTACK_RATIO = 42;
    private static int DEFENSE_RATIO = 84;
    private static int MIN_CP = 152;
    private static int MAX_CP = 263;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new Splash();
    ...
    public Magikarp(Context context, int id) {
        super(context, id);
    ...
    public Magikarp(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.magikarp);
        super.mResource = R.drawable.p129;
    }
