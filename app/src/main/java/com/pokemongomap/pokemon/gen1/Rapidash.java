...
public class Rapidash extends Pokemon {
    ...
    private static int MIN_CP = 1857;
    private static int MAX_CP = 2199;
    ...
    private static ChargeAttack CHARGE_ATTACK_2 = new HeatWave();
    private static ChargeAttack CHARGE_ATTACK_3 = new DrillRun();

    public Rapidash(Context context, int id) {
        super(context, id);
    ...
    public Rapidash(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.rapidash);
        super.mResource = R.drawable.p78;
    }
