...
public class Venomoth extends Pokemon {
    ...
    private static int MIN_CP = 1577;
    private static int MAX_CP = 1890;
    ...
    public Venomoth(Context context, int id) {
        super(context, id);
    ...
    public Venomoth(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.venomoth);
        super.mResource = R.drawable.p49;
    }
