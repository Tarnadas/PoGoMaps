...
public class Starmie extends Pokemon {
    ...
    private static int ATTACK_RATIO = 194;
    private static int DEFENSE_RATIO = 192;
    private static int MIN_CP = 1839;
    private static int MAX_CP = 2182;
    ...
    private static ChargeAttack CHARGE_ATTACK_2 = new PowerGem();
    private static ChargeAttack CHARGE_ATTACK_3 = new Psybeam();

    public Starmie(Context context, int id) {
        super(context, id);
    ...
    public Starmie(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.starmie);
        super.mResource = R.drawable.p121;
    }
