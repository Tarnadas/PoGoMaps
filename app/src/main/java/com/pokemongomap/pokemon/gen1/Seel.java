...
public class Seel extends Pokemon {
    ...
    private static int MIN_CP = 870;
    private static int MAX_CP = 1107;
    ...
    public Seel(Context context, int id) {
        super(context, id);
    ...
    public Seel(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.seel);
        super.mResource = R.drawable.p86;
    }
