...
public class Kangaskhan extends Pokemon {
    ...
    private static int ATTACK_RATIO = 142;
    private static int DEFENSE_RATIO = 178;
    private static int MIN_CP = 1715;
    private static int MAX_CP = 2043;
    ...
    private static ChargeAttack CHARGE_ATTACK_3 = new Stomp();

    public Kangaskhan(Context context, int id) {
        super(context, id);
        super.mResource = R.drawable.p115;
    ...
    public Kangaskhan(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.kangaskhan);
        super.mResource = R.drawable.p115;
    }

    @Override
    public boolean equals(Object obj) {
        return super.equals(obj) && obj instanceof Kangaskhan;
    }
}
