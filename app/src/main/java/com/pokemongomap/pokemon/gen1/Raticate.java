...
public class Raticate extends Pokemon {
    ...
    private static int ATTACK_RATIO = 146;
    private static int DEFENSE_RATIO = 150;
    private static int MIN_CP = 1171;
    private static int MAX_CP = 1444;
    ...
    public Raticate(Context context, int id) {
        super(context, id);
    ...
    public Raticate(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.raticate);
        super.mResource = R.drawable.p20;
    }
