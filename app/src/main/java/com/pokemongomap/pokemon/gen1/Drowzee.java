...
public class Drowzee extends Pokemon {
    ...
    private static int ATTACK_RATIO = 104;
    private static int DEFENSE_RATIO = 140;
    private static int MIN_CP = 842;
    private static int MAX_CP = 1075;
    ...
    public Drowzee(Context context, int id) {
        super(context, id);
    ...
    public Drowzee(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.drowzee);
        super.mResource = R.drawable.p96;
    }
