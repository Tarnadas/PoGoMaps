...
import com.pokemongomap.pokemon.attacks.basic.FeintAttack;
...
import com.pokemongomap.pokemon.attacks.charge.HeatWave;
...
import com.pokemongomap.pokemon.attacks.charge.PlayRough;
...
public class Jigglypuff extends Pokemon {
    ...
    private static int HP_RATIO = 230;
    private static int ATTACK_RATIO = 98;
    private static int DEFENSE_RATIO = 54;
    private static int MIN_CP = 682;
    private static int MAX_CP = 918;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new FeintAttack();
    private static BasicAttack BASE_ATTACK_2 = new Pound();
    private static List<ChargeAttack> CHARGE_ATTACKS = new ArrayList<>();
    private static ChargeAttack CHARGE_ATTACK_1 = new BodySlam();
    private static ChargeAttack CHARGE_ATTACK_2 = new DisarmingVoice();
    private static ChargeAttack CHARGE_ATTACK_3 = new PlayRough();
    ...
    public Jigglypuff() {
        ...
        super.MIN_CP = MIN_CP;
        super.MAX_CP = MAX_CP;
        super.TYPE = TypeModifier.Type.FAIRY;
        super.TYPE_SECONDARY = TypeModifier.Type.NORMAL;
