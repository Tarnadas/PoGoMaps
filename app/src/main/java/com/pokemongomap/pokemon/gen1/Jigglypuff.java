...
public class Jigglypuff extends Pokemon {
    ...
    public Jigglypuff(Context context, int id) {
        super(context, id);
    ...
    public Jigglypuff(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.jigglypuff);
        super.mResource = R.drawable.p39;
    }
