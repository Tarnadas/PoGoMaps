...
public class Poliwrath extends Pokemon {
    ...
    private static int MIN_CP = 2144;
    private static int MAX_CP = 2505;
    ...
    public Poliwrath(Context context, int id) {
        ...
        super.TYPE_SECONDARY = TypeModifier.Type.FIGHTING;
    ...
    public Poliwrath(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.poliwrath);
        super.mResource = R.drawable.p62;
    }
