...
public class Butterfree extends Pokemon {
    ...
    private static int MIN_CP = 1182;
    private static int MAX_CP = 1455;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new BugBite();
    private static BasicAttack BASE_ATTACK_2 = new Confusion();
    ...
    private static ChargeAttack CHARGE_ATTACK_3 = new SignalBeam();

    public Butterfree(Context context, int id) {
        super(context, id);
    ...
    public Butterfree(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.butterfree);
        super.mResource = R.drawable.p12;
    }
