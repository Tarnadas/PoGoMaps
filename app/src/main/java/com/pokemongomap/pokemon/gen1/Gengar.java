...
public class Gengar extends Pokemon {
    ...
    private static int MIN_CP = 1743;
    private static int MAX_CP = 2078;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new SuckerPunch();
    ...
    public Gengar(Context context, int id) {
        super(context, id);
    ...
    public Gengar(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.gengar);
        super.mResource = R.drawable.p94;
    }
