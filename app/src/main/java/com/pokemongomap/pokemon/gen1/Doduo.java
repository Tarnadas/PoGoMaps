...
public class Doduo extends Pokemon {
    ...
    private static int MIN_CP = 645;
    private static int MAX_CP = 855;
    ...
    private static ChargeAttack CHARGE_ATTACK_3 = new Swift();

    public Doduo(Context context, int id) {
        super(context, id);
    ...
    public Doduo(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.doduo);
        super.mResource = R.drawable.p84;
    }
