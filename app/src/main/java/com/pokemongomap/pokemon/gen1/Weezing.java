...
public class Weezing extends Pokemon {
    ...
    private static int MIN_CP = 1904;
    private static int MAX_CP = 2250;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new Tackle();
    private static BasicAttack BASE_ATTACK_2 = new Acid();
    ...
    public Weezing(Context context, int id) {
        super(context, id);
    ...
    public Weezing(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.weezing);
        super.mResource = R.drawable.p110;
    }
