...
public class Tentacruel extends Pokemon {
    ...
    private static int MIN_CP = 1880;
    private static int MAX_CP = 2220;
    ...
    public Tentacruel(Context context, int id) {
        super(context, id);
    ...
    public Tentacruel(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.tentacruel);
        super.mResource = R.drawable.p73;
    }
