...
public class Venusaur extends Pokemon {
    ...
    public Venusaur(Context context, int id) {
        super(context, id);
    ...
    public Venusaur(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.venusaur);
        super.mResource = R.drawable.p3;
    }
