...
public class Dragonite extends Pokemon {
    ...
    private static int HP_RATIO = 182;
    private static int ATTACK_RATIO = 250;
    private static int DEFENSE_RATIO = 212;
    private static int MIN_CP = 3067;
    private static int MAX_CP = 3500;
    ...
    private static ChargeAttack CHARGE_ATTACK_3 = new HyperBeam();

    public Dragonite(Context context, int id) {
        super(context, id);
        ...
        super.MIN_CP = MIN_CP;
        super.MAX_CP = MAX_CP;
        super.TYPE = TypeModifier.Type.DRAGON;
    ...
    public Dragonite(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.dragonite);
        super.mResource = R.drawable.p149;
    }
