...
public class Seadra extends Pokemon {
    ...
    private static int HP_RATIO = 110;
    private static int ATTACK_RATIO = 176;
    private static int DEFENSE_RATIO = 150;
    private static int MIN_CP = 1412;
    private static int MAX_CP = 1713;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new DragonBreath();
    ...
    private static ChargeAttack CHARGE_ATTACK_3 = new HydroPump();

    public Seadra(Context context, int id) {
        super(context, id);
    ...
    public Seadra(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.seadra);
        super.mResource = R.drawable.p117;
    }
