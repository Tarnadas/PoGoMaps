...
public class Squirtle extends Pokemon {
    ...
    public Squirtle(Context context, int id) {
        super(context, id);
    ...
    public Squirtle(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.squirtle);
        super.mResource = R.drawable.p7;
    }
