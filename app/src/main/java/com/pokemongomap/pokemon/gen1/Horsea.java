...
public class Horsea extends Pokemon {
    ...
    private static int DEFENSE_RATIO = 100;
    private static int MIN_CP = 590;
    private static int MAX_CP = 795;
    ...
    private static ChargeAttack CHARGE_ATTACK_3 = new FlashCannon();

    public Horsea(Context context, int id) {
        super(context, id);
    ...
    public Horsea(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.horsea);
        super.mResource = R.drawable.p116;
    }
