...
public class Lickitung extends Pokemon {
    ...
    private static int MIN_CP = 1336;
    private static int MAX_CP = 1627;
    ...
    private static ChargeAttack CHARGE_ATTACK_2 = new PowerWhip();
    private static ChargeAttack CHARGE_ATTACK_3 = new Stomp();

    public Lickitung(Context context, int id) {
        super(context, id);
        super.mResource = R.drawable.p108;
    ...
    public Lickitung(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.lickitung);
        super.mResource = R.drawable.p108;
    }

    @Override
    public boolean equals(Object obj) {
        return super.equals(obj) && obj instanceof Lickitung;
    }
}
