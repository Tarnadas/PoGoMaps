...
public class Nidoking extends Pokemon {
    ...
    private static int HP_RATIO = 162;
    private static int ATTACK_RATIO = 204;
    private static int DEFENSE_RATIO = 170;
    private static int MIN_CP = 2114;
    private static int MAX_CP = 2475;
    ...
    public Nidoking(Context context, int id) {
        super(context, id);
    ...
    public Nidoking(Context context, int id, LatLng loc, Date disappearTime) {
