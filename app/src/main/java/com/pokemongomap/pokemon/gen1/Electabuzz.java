...
public class Electabuzz extends Pokemon {
    ...
    private static int MIN_CP = 1784;
    private static int MAX_CP = 2119;
    ...
    private static ChargeAttack CHARGE_ATTACK_1 = new Thunder();
    private static ChargeAttack CHARGE_ATTACK_2 = new ThunderPunch();
    private static ChargeAttack CHARGE_ATTACK_3 = new Thunderbolt();

    public Electabuzz(Context context, int id) {
        super(context, id);
        super.mResource = R.drawable.p125;
    ...
    public Electabuzz(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.electabuzz);
        super.mResource = R.drawable.p125;
    }

    @Override
    public boolean equals(Object obj) {
        return super.equals(obj) && obj instanceof Electabuzz;
    }
}
