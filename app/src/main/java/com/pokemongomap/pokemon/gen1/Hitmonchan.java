...
public class Hitmonchan extends Pokemon {
    ...
    private static int ATTACK_RATIO = 138;
    private static int DEFENSE_RATIO = 204;
    private static int MIN_CP = 1231;
    private static int MAX_CP = 1517;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new BulletPunch();
    ...
    private static ChargeAttack CHARGE_ATTACK_3 = new IcePunch();

    public Hitmonchan(Context context, int id) {
        super(context, id);
        ...
        CHARGE_ATTACKS.add(new ThunderPunch());
        super.CHARGE_ATTACKS = CHARGE_ATTACKS;
    }

    public Hitmonchan(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.hitmonchan);
        super.mResource = R.drawable.p107;
    }
