...
public class Gloom extends Pokemon {
    ...
    private static int MIN_CP = 1393;
    private static int MAX_CP = 1689;
    ...
    public Gloom(Context context, int id) {
        super(context, id);
    ...
    public Gloom(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.gloom);
        super.mResource = R.drawable.p44;
    }
