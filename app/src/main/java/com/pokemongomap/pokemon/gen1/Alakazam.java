...
public class Alakazam extends Pokemon {
    ...
    private static int MIN_CP = 1502;
    private static int MAX_CP = 1814;
    ...
    public Alakazam(Context context, int id) {
        super(context, id);
    ...
    public Alakazam(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.alakazam);
        super.mResource = R.drawable.p65;
    }
