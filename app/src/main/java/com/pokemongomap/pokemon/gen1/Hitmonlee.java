...
public class Hitmonlee extends Pokemon {
    ...
    private static int MIN_CP = 1212;
    private static int MAX_CP = 1493;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new LowKick();
    private static BasicAttack BASE_ATTACK_2 = new RockSmash();
    private static List<ChargeAttack> CHARGE_ATTACKS = new ArrayList<>();
    private static ChargeAttack CHARGE_ATTACK_1 = new LowSweep();
    private static ChargeAttack CHARGE_ATTACK_2 = new Stomp();
    private static ChargeAttack CHARGE_ATTACK_3 = new StoneEdge();

    public Hitmonlee(Context context, int id) {
        super(context, id);
    ...
    public Hitmonlee(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.hitmonlee);
        super.mResource = R.drawable.p106;
    }
