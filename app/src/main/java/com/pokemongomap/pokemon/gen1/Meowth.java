...
public class Meowth extends Pokemon {
    ...
    private static int DEFENSE_RATIO = 94;
    private static int MIN_CP = 563;
    private static int MAX_CP = 756;
    ...
    private static ChargeAttack CHARGE_ATTACK_2 = new DarkPulse();
    private static ChargeAttack CHARGE_ATTACK_3 = new NightSlash();

    public Meowth(Context context, int id) {
        super(context, id);
    ...
    public Meowth(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.meowth);
        super.mResource = R.drawable.p52;
    }
