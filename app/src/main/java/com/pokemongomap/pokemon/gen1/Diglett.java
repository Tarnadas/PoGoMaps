...
public class Diglett extends Pokemon {
    ...
    private static int HP_RATIO = 20;
    private static int ATTACK_RATIO = 108;
    private static int DEFENSE_RATIO = 86;
    private static int MIN_CP = 280;
    private static int MAX_CP = 457;
    ...
    public Diglett(Context context, int id) {
        super(context, id);
    ...
    public Diglett(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.diglett);
        super.mResource = R.drawable.p50;
    }
