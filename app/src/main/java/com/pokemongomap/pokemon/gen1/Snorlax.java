...
public class Snorlax extends Pokemon {
    ...
    private static int HP_RATIO = 320;
    private static int ATTACK_RATIO = 180;
    private static int DEFENSE_RATIO = 180;
    private static int MIN_CP = 2698;
    private static int MAX_CP = 3113;
    ...
    public Snorlax(Context context, int id) {
        super(context, id);
    ...
    public Snorlax(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.snorlax);
        super.mResource = R.drawable.p143;
    }
