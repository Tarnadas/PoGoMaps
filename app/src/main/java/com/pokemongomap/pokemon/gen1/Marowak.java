...
public class Marowak extends Pokemon {
    ...
    private static int ATTACK_RATIO = 140;
    private static int DEFENSE_RATIO = 202;
    private static int MIN_CP = 1361;
    private static int MAX_CP = 1657;
    ...
    private static ChargeAttack CHARGE_ATTACK_3 = new Earthquake();

    public Marowak(Context context, int id) {
        super(context, id);
    ...
    public Marowak(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.marowak);
        super.mResource = R.drawable.p105;
    }
