...
public class Persian extends Pokemon {
    ...
    private static ChargeAttack CHARGE_ATTACK_1 = new NightSlash();
    private static ChargeAttack CHARGE_ATTACK_2 = new PlayRough();
    private static ChargeAttack CHARGE_ATTACK_3 = new PowerGem();

    public Persian(Context context, int id) {
        super(context, id);
    ...
    public Persian(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.persian);
        super.mResource = R.drawable.p53;
    }
