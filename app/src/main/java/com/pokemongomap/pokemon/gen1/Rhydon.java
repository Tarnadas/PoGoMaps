...
public class Rhydon extends Pokemon {
    ...
    private static int HP_RATIO = 210;
    private static int ATTACK_RATIO = 166;
    private static int DEFENSE_RATIO = 160;
    private static int MIN_CP = 1900;
    private static int MAX_CP = 2243;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new MudSlap();
    private static BasicAttack BASE_ATTACK_2 = new RockSmash();
    private static List<ChargeAttack> CHARGE_ATTACKS = new ArrayList<>();
    private static ChargeAttack CHARGE_ATTACK_1 = new Earthquake();
    private static ChargeAttack CHARGE_ATTACK_2 = new MegaHorn();
    private static ChargeAttack CHARGE_ATTACK_3 = new StoneEdge();

    public Rhydon(Context context, int id) {
        super(context, id);
        ...
        super.TYPE_SECONDARY = TypeModifier.Type.ROCK;
    ...
    public Rhydon(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.rhydon);
        super.mResource = R.drawable.p112;
    }
