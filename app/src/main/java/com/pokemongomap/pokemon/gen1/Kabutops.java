...
public class Kabutops extends Pokemon {
    ...
    private static int ATTACK_RATIO = 190;
    private static int DEFENSE_RATIO = 190;
    private static int MIN_CP = 1792;
    private static int MAX_CP = 2130;
    ...
    public Kabutops(Context context, int id) {
        super(context, id);
    ...
    public Kabutops(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.kabutops);
        super.mResource = R.drawable.p141;
    }
