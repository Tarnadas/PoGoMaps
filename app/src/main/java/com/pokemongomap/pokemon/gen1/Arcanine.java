...
public class Arcanine extends Pokemon {
    ...
    private static int ATTACK_RATIO = 230;
    private static int DEFENSE_RATIO = 180;
    private static int MIN_CP = 2586;
    private static int MAX_CP = 2984;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new Bite();
    private static BasicAttack BASE_ATTACK_2 = new FireFang();
    ...
    public Arcanine(Context context, int id) {
        super(context, id);
    ...
    public Arcanine(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.arcanine);
        super.mResource = R.drawable.p59;
    }
