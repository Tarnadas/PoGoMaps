...
public class Machop extends Pokemon {
    ...
    private static int ATTACK_RATIO = 118;
    private static int DEFENSE_RATIO = 96;
    private static int MIN_CP = 854;
    private static int MAX_CP = 1090;
    ...
    private static ChargeAttack CHARGE_ATTACK_3 = new LowSweep();

    public Machop(Context context, int id) {
        super(context, id);
    ...
    public Machop(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.machop);
        super.mResource = R.drawable.p66;
    }
