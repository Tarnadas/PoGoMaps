...
public class Wigglytuff extends Pokemon {
    ...
    public Wigglytuff(Context context, int id) {
        super(context, id);
    ...
    public Wigglytuff(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.wigglytuff);
        super.mResource = R.drawable.p40;
    }
