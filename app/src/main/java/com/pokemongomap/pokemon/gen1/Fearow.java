...
public class Fearow extends Pokemon {
    ...
    private static int DEFENSE_RATIO = 146;
    private static int MIN_CP = 1446;
    private static int MAX_CP = 1746;
    ...
    private static ChargeAttack CHARGE_ATTACK_2 = new Twister();
    private static ChargeAttack CHARGE_ATTACK_3 = new DrillRun();

    public Fearow(Context context, int id) {
        super(context, id);
    ...
    public Fearow(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.fearow);
        super.mResource = R.drawable.p22;
    }
