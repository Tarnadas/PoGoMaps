...
public class Metapod extends Pokemon {
    ...
    private static int HP_RATIO = 10;
    private static int ATTACK_RATIO = 56;
    private static int DEFENSE_RATIO = 86;
    private static int MIN_CP = 324;
    private static int MAX_CP = 478;
    ...
    public Metapod(Context context, int id) {
        super(context, id);
    ...
    public Metapod(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.metapod);
        super.mResource = R.drawable.p11;
    }
