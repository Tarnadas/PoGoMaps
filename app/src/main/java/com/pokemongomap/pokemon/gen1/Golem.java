...
public class Golem extends Pokemon {
    ...
    private static int DEFENSE_RATIO = 198;
    private static int MIN_CP = 1957;
    private static int MAX_CP = 2303;
    ...
    public Golem(Context context, int id) {
        super(context, id);
    ...
    public Golem(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.golem);
        super.mResource = R.drawable.p76;
    }
