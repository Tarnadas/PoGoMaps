...
public class Weepinbell extends Pokemon {
    ...
    private static int MIN_CP = 1419;
    private static int MAX_CP = 1724;
    ...
    public Weepinbell(Context context, int id) {
        super(context, id);
    ...
    public Weepinbell(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.weepinbell);
        super.mResource = R.drawable.p70;
    }
