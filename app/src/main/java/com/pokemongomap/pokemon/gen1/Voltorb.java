...
public class Voltorb extends Pokemon {
    ...
    public Voltorb(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.voltorb);
        super.mResource = R.drawable.p100;
    }
