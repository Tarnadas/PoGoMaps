...
public class Flareon extends Pokemon {
    ...
    private static int ATTACK_RATIO = 238;
    private static int DEFENSE_RATIO = 178;
    private static int MIN_CP = 2261;
    private static int MAX_CP = 2643;
    ...
    public Flareon(Context context, int id) {
        super(context, id);
    ...
    public Flareon(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.flareon);
        super.mResource = R.drawable.p136;
    }
