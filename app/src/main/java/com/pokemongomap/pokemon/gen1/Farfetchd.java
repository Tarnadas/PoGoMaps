...
public class Farfetchd extends Pokemon {
    ...
    public Farfetchd(Context context, int id) {
        super(context, id);
        super.mResource = R.drawable.p83;
    ...
    public Farfetchd(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.farfetchd);
        super.mResource = R.drawable.p83;
    }

    @Override
    public boolean equals(Object obj) {
        return super.equals(obj) && obj instanceof Farfetchd;
    }
}
