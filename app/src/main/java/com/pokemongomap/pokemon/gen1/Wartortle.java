...
public class Wartortle extends Pokemon {
    ...
    private static int HP_RATIO = 118;
    private static int ATTACK_RATIO = 144;
    private static int DEFENSE_RATIO = 176;
    private static int MIN_CP = 1296;
    private static int MAX_CP = 1583;
    ...
    public Wartortle(Context context, int id) {
        super(context, id);
    ...
    public Wartortle(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.wartortle);
        super.mResource = R.drawable.p8;
    }
