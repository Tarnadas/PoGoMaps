...
public class Paras extends Pokemon {
    ...
    private static int DEFENSE_RATIO = 120;
    private static int MIN_CP = 698;
    private static int MAX_CP = 917;
    ...
    public Paras(Context context, int id) {
        super(context, id);
    ...
    public Paras(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.paras);
        super.mResource = R.drawable.p46;
    }
