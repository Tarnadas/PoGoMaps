...
public class Dugtrio extends Pokemon {
    ...
    private static int MIN_CP = 915;
    private static int MAX_CP = 1169;
    ...
    public Dugtrio(Context context, int id) {
        super(context, id);
    ...
    public Dugtrio(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.dugtrio);
        super.mResource = R.drawable.p51;
    }
