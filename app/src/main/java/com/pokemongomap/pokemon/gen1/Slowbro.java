...
public class Slowbro extends Pokemon {
    ...
    private static int MIN_CP = 2229;
    private static int MAX_CP = 2597;
    ...
    public Slowbro(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.slowbro);
        super.mResource = R.drawable.p80;
    }
