...
public class Graveler extends Pokemon {
    ...
    private static int DEFENSE_RATIO = 156;
    private static int MIN_CP = 1162;
    private static int MAX_CP = 1434;
    ...
    public Graveler(Context context, int id) {
        super(context, id);
    ...
    public Graveler(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.graveler);
        super.mResource = R.drawable.p75;
    }
