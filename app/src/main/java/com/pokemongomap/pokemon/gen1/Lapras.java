...
public class Lapras extends Pokemon {
    ...
    private static int HP_RATIO = 260;
    private static int ATTACK_RATIO = 186;
    private static int DEFENSE_RATIO = 190;
    private static int MIN_CP = 2582;
    private static int MAX_CP = 2981;

    private static List<BasicAttack> BASE_ATTACKS = new ArrayList<>();
    private static BasicAttack BASE_ATTACK_1 = new FrostBreath();
    private static BasicAttack BASE_ATTACK_2 = new IceShard();
    private static List<ChargeAttack> CHARGE_ATTACKS = new ArrayList<>();
    private static ChargeAttack CHARGE_ATTACK_1 = new Blizzard();
    private static ChargeAttack CHARGE_ATTACK_2 = new DragonPulse();
    private static ChargeAttack CHARGE_ATTACK_3 = new IceBeam();

    public Lapras(Context context, int id) {
        super(context, id);
        ...
        super.TYPE_SECONDARY = TypeModifier.Type.ICE;
    ...
    public Lapras(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.lapras);
        super.mResource = R.drawable.p131;
    }
