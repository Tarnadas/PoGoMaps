...
public class Spearow extends Pokemon {
    ...
    private static int MIN_CP = 503;
    private static int MAX_CP = 687;
    ...
    private static ChargeAttack CHARGE_ATTACK_2 = new DrillPeck();
    private static ChargeAttack CHARGE_ATTACK_3 = new Twister();

    public Spearow(Context context, int id) {
        super(context, id);
    ...
    public Spearow(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.spearow);
        super.mResource = R.drawable.p21;
    }
