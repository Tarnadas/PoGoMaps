...
public class Eevee extends Pokemon {
    ...
    private static int ATTACK_RATIO = 114;
    private static int DEFENSE_RATIO = 128;
    private static int MIN_CP = 845;
    private static int MAX_CP = 1077;
    ...
    public Eevee(Context context, int id) {
        super(context, id);
    ...
    public Eevee(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.eevee);
        super.mResource = R.drawable.p133;
    }
