...
public class Omanyte extends Pokemon {
    ...
    private static int MAX_CP = 1120;
    ...
    private static ChargeAttack CHARGE_ATTACK_2 = new RockTomb();
    private static ChargeAttack CHARGE_ATTACK_3 = new Brine();

    public Omanyte(Context context, int id) {
        super(context, id);
    ...
    public Omanyte(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.omanyte);
        super.mResource = R.drawable.p138;
    }
