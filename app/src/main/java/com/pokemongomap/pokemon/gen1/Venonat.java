...
public class Venonat extends Pokemon {
    ...
    private static int MIN_CP = 803;
    private static int MAX_CP = 1029;
    ...
    public Venonat(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.venonat);
        super.mResource = R.drawable.p48;
    }
