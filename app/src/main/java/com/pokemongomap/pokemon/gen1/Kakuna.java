...
public class Kakuna extends Pokemon {
    ...
    private static int MIN_CP = 333;
    private static int MAX_CP = 485;
    ...
    public Kakuna(Context context, int id) {
        super(context, id);
        super.mResource = R.drawable.p14;
    ...
    public Kakuna(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.kakuna);
        super.mResource = R.drawable.p14;
    }

    @Override
    public boolean equals(Object obj) {
        return super.equals(obj) && obj instanceof Kakuna;
    }
}
