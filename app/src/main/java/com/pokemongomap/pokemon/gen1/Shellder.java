...
public class Shellder extends Pokemon {
    ...
    private static int ATTACK_RATIO = 120;
    private static int DEFENSE_RATIO = 112;
    private static int MIN_CP = 614;
    private static int MAX_CP = 823;
    ...
    private static ChargeAttack CHARGE_ATTACK_2 = new IcyWind();
    private static ChargeAttack CHARGE_ATTACK_3 = new WaterPulse();

    public Shellder(Context context, int id) {
        super(context, id);
    ...
    public Shellder(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.shellder);
        super.mResource = R.drawable.p90;
    }
