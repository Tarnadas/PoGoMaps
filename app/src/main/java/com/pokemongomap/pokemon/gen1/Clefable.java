...
public class Clefable extends Pokemon {
    ...
    private static int HP_RATIO = 190;
    private static int ATTACK_RATIO = 178;
    private static int DEFENSE_RATIO = 178;
    private static int MIN_CP = 2045;
    private static int MAX_CP = 2398;
    ...
    private static ChargeAttack CHARGE_ATTACK_2 = new Moonblast();
    private static ChargeAttack CHARGE_ATTACK_3 = new Psychic();

    public Clefable(Context context, int id) {
        super(context, id);
    ...
    public Clefable(Context context, int id, LatLng loc, Date disappearTime) {
        super(id, loc, disappearTime);
        super.mName = context.getString(R.string.clefable);
        super.mResource = R.drawable.p36;
    }
